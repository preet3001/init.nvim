...
- on Linux and Mac
```sh
git clone https://github.com/preet3001/init.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```

- on Windows (cmd)
```
git clone https://github.com/preet3001/init.nvim.git %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/preet3001/init.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
